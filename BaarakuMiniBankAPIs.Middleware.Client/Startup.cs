using BaarakuMiniBankAPIs.Middleware.Client.Dependencies;
...
namespace BaarakuMiniBankAPIs.Middleware.Client
{
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (Configuration.GetValue<bool>("SystemSettings:UseSwagger"))
            {
                ...
                app.UseSwaggerUI(s =>
                {
                    ...
                    s.SwaggerEndpoint($"{swaggerJsonBasePath}/swagger/v1/swagger.json", "Baaraku Mini Bank APIs");
                });
            }
            app.UseRouting();
